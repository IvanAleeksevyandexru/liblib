import {
  ...
  SimpleChanges,
  OnChanges,
  OnDestroy, NgModuleRef, ChangeDetectorRef, ViewChildren, QueryList, ChangeDetectionStrategy, Output,
  EventEmitter
} from '@angular/core';
...
import { DragDropBinding, DragDropType, DragDropDirection, DragDropOffsetType, DragState } from '@epgu/ui/models/drag-drop';
...
export class SliderComponent implements AfterViewInit, OnChanges, OnDestroy {
  ...
  @Output() public openModal = new EventEmitter<number>();

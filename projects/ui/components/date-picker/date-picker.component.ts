...
import { StandardMaskedInputComponent } from '@epgu/ui/components/standard-masked-input';
  ...
  public attachDescriptors() {
    ...
    if (this.containerOverlap) {
      this.positioningDescriptor = {
        master: this.fieldContainer, slave: this.calendarContainer,

...
import { Tab, Tabs, ASIDE_TABS } from '@epgu/ui/models';
import { TabsComponent } from '@epgu/ui/components/tabs';
import { Translation, ModelControl } from '@epgu/ui/models/common-enums';

...
@Component({
  template: `<lib-base-masked-input #input [mask]="mask" [(ngModel)]="value" [commitOnInput]="false"></lib-base-masked-input>`
})
class NgModelComponent extends CorrectInitialValue {
  @ViewChild('input', {static: true}) public input: BaseMaskedInputComponent;
...
@Component({
  template: `<lib-base-masked-input #input [mask]="mask" [(ngModel)]="value"
    [showMaskAsPlaceholder]="true" [commitOnInput]="false"></lib-base-masked-input>`
})
...
@Component({
  template: `<div [formGroup]="form"><lib-base-masked-input #input [mask]="mask" formControlName="mask"
    [commitOnInput]="false"></lib-base-masked-input></div>`
})
...
@Component({
  template: `<lib-base-masked-input #managed (focus)="otherInputFocusReceived()"
                (blur)="otherInputBlured()" contextClass="managed"></lib-base-masked-input>
    <lib-base-masked-input #input (focus)="focusReceived()"
                (blur)="inputBlured()" contextClass="base"></lib-base-masked-input>
...
class FocusTestComponent {
  ...
  public managed: BaseMaskedInputComponent;
  @ViewChild('unmanaged', {static: true})
  public unmanaged: HTMLInputElement;
  @ViewChild('input', {static: true})
  public input: BaseMaskedInputComponent;
...
@Component({
  template: `<lib-base-masked-input (change)="change()" (input)="input()" (focus)="focus()" (blur)="blur()"
            ...
            (mouseenter)="mouseenter()" (mouseleave)="mouseleave()" (mouseover)="mouseover()"
                (mouseout)="mouseout()" (mousemove)="mousemove()"></lib-base-masked-input>`
})
...
describe('BaseMaskedInputComponent', () => {
  let component: BaseMaskedInputComponent;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        ...
        NgModelComponent, NgBrokenModelComponent, NgEmptyModelComponent, MaskPlaceholderComponent,

...
import { InputAutocomplete, RemoveMaskSymbols, ValidationShowOn } from '@epgu/ui/models/common-enums';
...
export class BaseMaskedInputComponent
  ...
  @Input() public mask: ((value: string) => Array<string | RegExp> | Array<string | RegExp>) | (string | RegExp)[];
